<!-- xss/vulnerable/comentarios.php -->
<?php
// VULNERABLE: XSS persistente
...
<head>
    ...
    <title>Comentarios - Vulnerable a XSS</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h1>Comentarios Vulnerables</h1>
        
        <div class="hint">
            <p>Esta página es vulnerable a ataques XSS. Intenta añadir el siguiente comentario: 

...
if ($_POST) {
    ...
    if (empty($titulo)) {
        ...
        if (PostManager::updatePost($post_id, $post_data)) {
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar p-0">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column px-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white active" href="posts.php">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            ...
                            <?php if ($post['publicado']): ?>
                                <a href="../post.php?slug=<?= htmlspecialchars($post['slug']) ?>" class="btn btn-outline-success" target="_blank">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card shadow-sm">
                            <div class="card-header">
                                <h5 class="mb-0">
                                    <i class="bi bi-pencil-square me-2"></i>Editar Detalles del Post
                                </h5>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="">
                                    ...
                                    <div class="mb-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="publicado" name="publicado" 
                                                   <?= $_POST['publicado'] ? 'checked' : '' ?>>
                                            <label class="form-check-label" for="publicado">
                                                <strong>Publicar post</strong>
                                            </label>
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bi bi-check-circle me-1"></i>Actualizar Post
                                        </button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <p class="small mb-2"><strong>ID:</strong> <?= $post['id'] ?></p>
                                <p class="small mb-2"><strong>Slug:</strong> <?= htmlspecialchars($post['slug']) ?></p>
                                <p class="small mb-2"><strong>Autor:</strong> <?= htmlspecialchars($post['autor']) ?></p>
                                <p class="small mb-2"><strong>Creado:</strong> <?= formatDate($post['fecha_creacion']) ?></p>
                                <p class="small mb-2"><strong>Actualizado:</strong> <?= formatDate($post['fecha_actualizacion']) ?></p>
                                <p class="small mb-0">
                        ...
                        <div class="card shadow-sm mt-3">
                            <div class="card-header">
                                <h6 class="mb-0">
                                    <i class="bi bi-lightbulb me-2"></i>Consejos para editar
                                </h6>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled mb-0">
                                    <li class="mb-3">
                                        ...
                                        <strong>Revisa el contenido:</strong> Asegúrate de que esté bien estructurado
                                    </li>
                                    <li class="mb-3">
                                        <i class="bi bi-check-circle text-success me-2"></i>
                                        <strong>Actualiza los tags:</strong> Mantén relevantes las palabras clave
                                    </li>
                                    <li class="mb-3">
                                        <i class="bi bi-check-circle text-success me-2"></i>
                                        <strong>Verifica la categoría:</strong> Debe reflejar el contenido actual
                                    </li>
                                    <li class="mb-0">
                                        <i class="bi bi-check-circle text-success me-2"></i>
                                        <strong>Estado de publicación:</strong> Cambia entre borrador y publicado según necesites
                                    </li>
                                </ul>
                            </div>
                        </div>
